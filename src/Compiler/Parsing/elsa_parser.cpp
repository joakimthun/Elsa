...
namespace elsa {
	namespace compiler {
		...
		void ElsaParser::initialize_grammar()
		{
			...
			register_ll2_expression_parser(TokenType::Byte, TokenType::LParen, new TypeCastParser());
			...
			register_expression_parser(TokenType::Byte, new VariableDeclarationParser());
			...
			register_expression_parser(TokenType::LParen, new GroupedExpressionParser());
			...
			register_infix_parser(TokenType::Percent, new BinaryOperatorParser(Precedence::Product));
